                ...
                <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="modules-links"' : 'id="xs-modules-links"' }>
                                ...
                                <a href="modules/AppModule.html" data-type="entity-link">AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-f246e636b976977134372a154ffd979e"' : 'data-target="#xs-components-links-module-AppModule-f246e636b976977134372a154ffd979e"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-f246e636b976977134372a154ffd979e"' :
                                            'id="xs-components-links-module-AppModule-f246e636b976977134372a154ffd979e"' }>
                                            <li class="link">
                            ...
                            <li class="link">
                                <a href="modules/DetailModule.html" data-type="entity-link">DetailModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-DetailModule-8775976966e6bc55c7dbce1c177ebdbb"' : 'data-target="#xs-components-links-module-DetailModule-8775976966e6bc55c7dbce1c177ebdbb"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-DetailModule-8775976966e6bc55c7dbce1c177ebdbb"' :
                                            'id="xs-components-links-module-DetailModule-8775976966e6bc55c7dbce1c177ebdbb"' }>
                                            <li class="link">
                            ...
                            <li class="link">
                                <a href="modules/SharedModule.html" data-type="entity-link">SharedModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-SharedModule-b62c2005fbcbafe1a01351234d4e19d9"' : 'data-target="#xs-components-links-module-SharedModule-b62c2005fbcbafe1a01351234d4e19d9"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-SharedModule-b62c2005fbcbafe1a01351234d4e19d9"' :
                                            'id="xs-components-links-module-SharedModule-b62c2005fbcbafe1a01351234d4e19d9"' }>
                                            <li class="link">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="components-links"' : 'id="xs-components-links"' }>
                            ...
                            <li class="link">
                                <a href="components/SharedButtonComponent.html" data-type="entity-link">SharedButtonComponent</a>
                            </li>
                            <li class="link">
                                <a href="components/SharedCardComponent.html" data-type="entity-link">SharedCardComponent</a>
                            </li>
                        </ul>
                    </li>
                        <li class="chapter">
